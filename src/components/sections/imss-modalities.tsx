...
import { IMSS_ALLY, IMSS_MODALITIES, WHATSAPP_URL_MODALIDADES } from "@/lib/site-data";

export function ImssModalities() {
  return (
    <section id="modalidades" className="mx-auto max-w-6xl px-(--spacing-gutter) py-(--spacing-section)">
      <div className="overflow-hidden rounded-3xl border border-border bg-surface">
        <Reveal>
          <div className="relative h-48 w-full sm:h-64">
            <Image
              src="/images/modalidad-imss.jpg"
              alt="Asesor revisando en una tablet la gráfica de una pensión"
              fill
        ...
        <div className="p-8 sm:p-12">
          ...
          <Reveal delay={0.14}>
            <p className="mt-5 max-w-2xl text-[15px] leading-relaxed text-foreground/80">
              ...
              pocas personas saben que existen o si les conviene. {IMSS_ALLY.blurb}
            </p>
          </Reveal>
          ...
          <Reveal delay={0.3}>
            <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-muted underline underline-offset-4 hover:text-foreground/80"
              >
                Conoce a nuestro aliado en {IMSS_ALLY.name}
              </a>
            </div>
          </Reveal>
        </div>
