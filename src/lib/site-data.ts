...
export const ALSO_SOLVE = [
  ...
  },
  {
    ...
    body: "Trabajamos con aliados especializados:",
    list: [
      "Modalidad 40 — en toda la República, con APE (Asesores Previsionales Especializados).",
      "Modalidad 10 — en toda la República, con APE (Asesores Previsionales Especializados).",
      "Revisión de tu Afore — solo en CDMX, con un agente certificado independiente.",
    ],
    footnote: null,
